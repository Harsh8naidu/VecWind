...
VecWind provides a real-time, grid-based 3D wind field for Unreal Engine Niagara systems. It supports CPU and GPU Niagara simulation, runtime wind injection, turbulence, and multiple WindField data interfaces in one GPU Niagara system.
